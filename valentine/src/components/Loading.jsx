    ...
    return (
        <div className="min-h-screen absolute top-0 w-full bg-slate-900">
            ...
            <div className="flex items-center flex-col gap-2 w-80  mx-auto shadow-2xl p-10">
                <input value={name} onChange={(e) => setName(e.target.value)} className="px-10 py-4 rounded-lg bg-white  font-semibold  outline-none outline-purple-800" type="text" placeholder="Enter here" />
                <button onClick={handleSubmit} className="py-2 px-8 rounded-full font-semibold text-white hover:bg-blue-950 bg-blue-800">Submit</button>
